				...
				<h:form id="other">
					...
					<h:dataTable id="NewQueryTable" value="#{doctorBean.otherQueriesList}"
						...
						<h:column>
							...
							<h:outputText value="#{other.queryId}"></h:outputText>
						</h:column>
						...
						<h:column>
							...
							<h:outputText value="#{other.queryCategory}"></h:outputText>
						</h:column>
						...
						<h:column>
							...
							<h:outputText value="#{other.queryDescription}"></h:outputText>
						</h:column>
						...
						<h:column>
							...
							<h:outputText value="#{other.queryDate}"></h:outputText>
						</h:column>
						...
						<h:column>
							...
							<h:outputText value="#{other.doctorsReply}"></h:outputText>
						</h:column>
