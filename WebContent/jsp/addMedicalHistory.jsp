...
<script type="text/javascript">
	...
	function cancelPage() {
		...
		document.getElementById("addingHistory:cancelLink").click();
	...
	<f:view>
		...
		<div class="jumbotron">
			<div class="container">
				...
				<br>
				<h:form id="addingHistory">


					<h:outputLabel value="Date:"></h:outputLabel>
					<br>
					<h:inputText value="#{patientBean.patientHistoryDate}">

					</h:inputText> <h:outputLabel value="mm/dd/yyyy" />
...
<%-- 		
	...
	--%>	
				...
				<br>
					...
					<br>
					<h:inputTextarea value="#{patientBean.patientHistoryDescription}"
				...
				<br>
					...
					<h:commandButton action="#{patientBean.insertPatientHistory}"
						value="Add History" styleClass="btn btn-success">
